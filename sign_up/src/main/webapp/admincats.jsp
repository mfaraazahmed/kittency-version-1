...
<div class="row detail-container container">
  ...
  <div class="inner-table">
    <table class="table admin-table table-borderless">
        <thead>
            <tr>
                <th class="table-data" scope="col">Cat id</th>
                <th class="table-data" scope="col">Breed</th>
                <th class="table-data" scope="col">Age</th>
                <th class="table-data" scope="col">Price</th>
    ...
    <% while(res.next()) { %>
        <tbody>
        <tr>
            <th class="table-data" scope="row"><%=res.getInt("cat_id") %></th>
            <td class="table-data"><%=res.getString("cat_breed") %></td>
            <td class="table-data"><%=res.getInt("cat_age") %></td>
            <td class="table-data"><%=res.getInt("price")%> </td>
            <td >
                <form action="deletecats.jsp" method="post" class="form-group form-button">
                    <input type="hidden" name="cat_id" value="<%=res.getInt("cat_id") %>">
