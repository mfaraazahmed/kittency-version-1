...
<div class="profile-body">
    ...
    String sql = "SELECT uname, uemail, umobile FROM users WHERE id = ?";
    ...
    if (rs.next()) {
        ...
        sellerEmail = rs.getString("uemail");
        sellerMobile = rs.getString("umobile");
    }
%>
		
		</div>
		
			<div class="heading"><i class="zmdi zmdi-account"></i> User details</div>
			<div class="account-id-display">Account ID : <%= user_id %></div>
			...
			<div class="profile-block">
				...
				<div class="value"><%= sellerMobile %></div>
				<div class="mid-line"></div>
			</div>
			<div class="profile-block">
