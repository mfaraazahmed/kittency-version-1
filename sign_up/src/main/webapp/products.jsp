...
%>
  				...
  				<div class="form-text-inputs">
  					<div class="form-input-block">
						<label for="pname">Name</label>
  						<input type="text" id="product-name" name="pname" placeholder="Enter product name">
					</div>
					<div class="form-input-block">
						<label for="pqty">Price</label>
  						<input type="number" id="pqty" name="pqty" placeholder="Enter the price in rupees">
					</div>
					<div class="form-input-block">
						<label for="pexp">Exp. Date</label>
  						<input type="text" id="pexp" name="pexp" placeholder="Enter expiary date">
					</div>
					<div class="form-input-block">
						<label for="pmfc">Mfg. Date</label>
  						<input type="text" id="pmfc" name="pmfc" placeholder="Enter manufacturing date">
					</div>
  				</div>
	...
	<div class="alt-redirection">Or, click here to <a href="sell.jsp">sell cats</a></div>
	</div>
</div>
