...
<div class="contact-seller">
	...
	<div class="form-section">
		<div class="cat-img">
			<img src="images/cat-food.jpeg" class="profile-img" alt="...">
		</div>
	...
	%>
		...
		<div class="details">
			<div class="product-details"><span class="left-title">Product name</span> : <span class="right-title"><%=pname %></span></div>
			<div class="product-details"><span class="left-title">Price</span>  : <span class="right-title"><%=pqty %></span></div>
			<div class="product-details"><span class="left-title">Mfg. Date</span>  : <span class="right-title"><%=pmfc %></span></div>
			<div class="product-details"><span class="left-title">Exp. Date</span>  : <span class="right-title"><%=pexp %></span></div>
